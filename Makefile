...
# PlayStation Vita
   ...
   CPUFLAGS += -DNO_ASM  -DARM -D__arm__ -DARM_ASM -D__NEON_OPT -DUSE_GL1 -DPLATFORM_LINUX
   CPUFLAGS += -w -mthumb -mcpu=cortex-a9 -mfpu=neon -mfloat-abi=hard -D__arm__ -g -O2 -ftree-vectorize -fno-optimize-sibling-calls
   HAVE_NEON = 1
